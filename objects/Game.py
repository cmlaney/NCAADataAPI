...
class Possession(object):
    ...
    def __init__(self, teamName, time, plays, id=-1):
        ...
        for play in plays:
            ...
            newPlay = Play(play['scoreText'], play['driveText'], lastVScore, lastHScore)
...
class Play(object):
    ...
    def __init__(self, text, drive, vScore, hScore):
        try:
    ...
    def __str__(self):
        try:
            return 'Home: {}\tAway: {}'.format(self.hScore, self.vScore)
        except UnicodeEncodeError:
